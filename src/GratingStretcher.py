...
lens0 = oe.PCXElement(x=np.array([0, 0, 100e-3]), r=300e-3, thickness=4.4e-3, material=fs, size=50.8e-3)
...
screen = oe.ScreenElement(x=np.array([0, 0, 500-3]))
...
opt_sys.rotate_optical_axis_after_element(0, -76 * np.pi / 180, 0)
