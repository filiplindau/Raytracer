...
devAngle = 68.0*np.pi/180
prismAngle = 33*np.pi/180
apex = 58 * np.pi / 180
...
prism2 = oe.PrismElement(x=np.array([prismOffset + 5e-3 - prism2Insert, 0, 1200e-3]), n=1.5, apexAngle=apex, sideLength=50e-3, material=prismMat)
prism2.reverseElement()
prism2.rotateElement(0, np.pi-prismAngle)

prism3 = oe.PrismElement(x=np.array([prismOffset + -5e-3 - prism3Insert, 0, 200e-3]), n=1.5, apexAngle=apex, sideLength=50e-3, material=prismMat)
